...
public class ReservaSala extends Command {

	private static final Event id = Event.CREAR_RESERVA_SALA;
	public ReservaSala() {
		super(id);
	...
	public boolean execute(Object o) {
		...
		Pair<Event, String> response = s.reservar(res.getKey(), Integer.toString(res.getValue()));
		if(response != null)
