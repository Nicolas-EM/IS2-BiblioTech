...
public class RegresarLibro extends Command {

	private static final Event id = Event.REGRESAR;
	...
	public boolean execute(Object o) {
		...
		Pair<Event, String> response = l.cancelar_reserva(res.getKey(), Integer.toString(res.getValue()));
		if(response != null)
